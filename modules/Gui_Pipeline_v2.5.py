...
# This version covers all events + structured( progressbar threading (gui_kit.ipynb) + fitting progressbar) 
#+ font + ppt/word desabled toolbar buttons + new design + validate only one time +test on folder without txt files + events(add + check box + parameters settings)
# + run single +export + run all + cleaned database + skiprows deleted + windows expanding+ main window + good structure.
...
class Inputable:
    ...
    def get_inputline(self):
        ...
        line = self.inputable.loc[self.key,:]
        return line
...
class Progress_bar(QDialog):
    def __init__(self):
        ...
        self.call = uic.loadUi('progressbar_2.ui', self) # Load the .ui file
        self.show()
...
class input_window(QDialog):
    def __init__(self,parent,text=''):
        ...
        self.text = text
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.insert = uic.loadUi('input_0.ui', self) # Load the .ui file 
...
class database_import(QDialog):
    def __init__(self):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('database_0.ui', self) # Load the .ui file
    ...
    def validate(self):
        try:
            ...
            if self.database_path == '':
                    self.database_path = 'newdatabase.db'
            else:
                pass
...
class insert_window(QDialog):
    def __init__(self,path=None,parent =None):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('insert_1.ui', self) # Load the .ui file # Load the .ui file
        self.path = path
        self.specimen = parent
...
class delete_window(QDialog):
    def __init__(self,path=None):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('delete_search_0.ui', self) # Load the .ui file # Load the .ui file
...
def main():
    app = QApplication(sys.argv) # Create an instance of QApplication
    window = delete_window('specimen.db')
    #db.connections.close_all()# Create an instance of our class
    #app.aboutToQuit.connect(app.deleteLater)
    app.exec_() # Start the application     
#main()
...
def main():
    app = QApplication(sys.argv) # Create an instance of QApplication
    window = search_window('specimen.db')
    window.show()
    #db.connections.close_all()# Create an instance of our class
    #app.aboutToQuit.connect(app.deleteLater)
    app.exec_() # Start the application     
...
class parameters_window(QDialog):
    def __init__(self,parent):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('parameters_2.ui', self) # Load the .ui file # Load the .ui file
...
class database_window(QDialog):
    def __init__(self,head=None,databasepath=None):
        ...
        self.box = uic.loadUi('box_1.ui', self) # Load the .ui file 
...
class datareduction_gui(QDialog,Pipeline):
    ...
    def __init__(self):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('gui_5.ui', self) # Load the .ui file
    ...
    def validate_inputs_on_click(self):
        ...
        if(self.inputfolder is not None and self.testablefile is not None and self.outputpath is not None) :
            ...
            self.window_progressbar_validate.setWindowTitle('Loding...')
...
class funny_msg(QDialog):
    ...
    def __init__(self):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('Funny_msg.ui', self) # Load the .ui file
        #self.show()
...
class developer_infos(QDialog):
    ...
    def __init__(self):
        ...
        '''Load the ui'''
        QDialog.__init__(self) # Call the inherited classes __init__ method
        self.call = uic.loadUi('coordinates.ui', self) # Load the .ui file
        #self.show()
...
class main_window_gui(QMainWindow):
    def __init__(self):
        ...
        self.call = uic.loadUi('tool.ui', self) # Load the .ui file
    ...
    def GUI_ppt(self):
        try:
            link = 'C:/Users/elh/Desktop/test_data_gui/Datareduction guideline.pptx'
            os.startfile(link)
        except Exception:
             buttonReply = QMessageBox.critical(self, 
